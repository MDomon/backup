...
<body>
	...
	<ul class= "form-style">
			...
			<li class= "list">
				...
				<s:property value="errorMessage" /></s:if></span></li>
			...
			<li class= "list"><s:submit value="enter" /><br><br><input type="button" class= "login"  value="戻る" onclick="history.back()">&emsp;&emsp;<a class= "login" href= '<s:url action= "GoHomeAction" />'>&#x1f3e0;</a></li>
	...
	<br>
	<a class= "login" href='<s:url action="UserCreateAction" />'>新規ユーザー登録</a>
	<br><br></div>
