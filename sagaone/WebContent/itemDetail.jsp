	...
	<header class="clearfix">
		<div id="main-logo">
			<a href=' <s:url action= "GoHomeAction" /> '><img
				src="./img/sagaone_logo.png" height="100px"></a>
		</div>
		<div class="clearfix">
			<div id="search-form">
				<s:form action="SearchItemAction">
					...
					<div class="search-btn">
						<input type="image" src="./img/searchIcon.png" width="20"
			...
			<div id="header-container">
				<ul id="normal" class="dropmenu">
					...
					<li id="welcome"><s:if test="#session.loginFlg">
				...
				<s:form action="CartAction">
					...
					<div class="main1-2">
						...
						<input type="hidden" name="product_id"
							value="<s:property value="productId" />"></input>  <input
							type="hidden" name="category_id"
							value="<s:property value="categoryId" />"></input> <input
							type="hidden" name="randomCart"
							value="<s:property value='#session.randomCart' />"></input>
				...
				<div class="main2-2-2">
					<s:iterator value="#session.itemdetailDTOList">
						<s:form action="ReviewAction">
							...
							<input type="hidden" name="detailflg"
								value="<s:property value='detailflg' />"></input>
			...
			<div class="main2-2">
				<s:iterator value="#session.reviewDTO2List">
					<ul>
						...
						<li><div class="review">
								<s:property value="rereview" escape="false" />
							</div></li>
