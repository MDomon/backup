			...
			<table id="main-table">
				...
				<tr>
					...
					<tr>
						...
						<td>
								<input id="stringRow" type="text" name="password" type= "text" placeholder="半角英数字・3～16字" size="35"/>
						</td>
						<td>
					...
					<tr>
						<td id="backt-btn"><input id="page" type="button" onclick="location.href=' <s:url action= "StartAction" />'"value="戻る"></td>
						<td id="submit-btn"><s:submit value="登録"/></td>
					</tr>
