...
<body>
	...
	<div id="main">
		...
		<s:if test="cartList == null">
			<h3 class="blank">カートに商品が入っていません。</h3>

				<s:form action="SearchItemAction">
					<input type="hidden" name="itemCategory" value="0" />
					<input type="hidden" name="searchWord" value="" />
						<center><input type= "submit" value="商品一覧" class= "item" /></center>
								</s:form>
		</s:if>
			...
			<s:form action="CartAction" name="cart">
				<table class="zebra">
					...
					<s:iterator value="cartList">
						<tr>
							<td class="check1"><s:checkbox name="checkboxList"
									value="checked" fieldValue="%{id}" class="check" /></td>
							<td class="cart10"><s:property value="productName" /></td>
							<td class="cart11"><s:property value="productNameKana" /></td>
							<td class="cart12"><img
								src='<s:property value="imageFilePath" />' height="100"></td>
