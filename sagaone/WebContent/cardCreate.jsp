	...
	<div id="main">
		<table>
				...
				<p class ="error">
					...
					<tr>
						<td><input type="hidden" name="fromPayment" value="<s:property value="fromPayment" />" /></td>
						<td><input type="hidden" name="adNum" value="<s:property value="adNum" />" /></td>
					</tr>
					<tr>
						<td><input id="page" type="button" onclick="history.back()" value="戻る"></td>
