		...
		<s:iterator value="#session.reviewProductList">
			<div class="purchase-list">
				...
				<div class="item clearfix">
					...
					<ul class="detail">
						<li class="price">金額:<s:property value="price"/>円</li>
						<li class="release-date">発売日:<s:property value="releaseDate" /></li>
						<li class="rate-star">
							<div class="dd">
								<div class="rating">
						...
						<li class="review-description">
							<s:property value="review" escape="false" />
						</li>
					</ul>
					<div class="review">
						<input class="btn l-btn" type="button" onclick="location.href='<s:url action="ReviewAction"><s:param name="product_id" value="productId" /><s:param name="category_id" value="categoryId" /><s:param name="reviewFlg" value="1" /><s:param name="fromReviewHistory" value="1" /></s:url>'"value="修正">
