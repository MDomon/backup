...
public class A {
	...
	public static void main(String[] args) throws IOException
	{
		...
		*/
		...
		System.out.println("5教科の合計点は"+ (num1 + num2 + num3 + num4 + num5) +"です。");
		System.out.println("5教科の平均点は"+ ((num1 + num2 + num3 + num4 + num5) / (double)5) +"です。");
		*/
	...
	*/
		...
		*/
		...
		test2[2] = 100;
		System.out.println("test2が指す3番目の人の点数を変更します。");
