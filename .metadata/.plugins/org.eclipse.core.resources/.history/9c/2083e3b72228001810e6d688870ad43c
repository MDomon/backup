    ...
    <body>
        <div id="page">
			...
			<div id="main">
				...
				<div>
					<table>
						<s:form action="BookCreateCompleteAction">
							<tr id="box">
								<td>
									<label>著書名:</label>
								</td>
								<td>
									<s:property value="book_name" escape="false" />
								</td>
							</tr>
							<tr id="box">
								<td>
								...
								<td>
									<s:property value="book_author_name" escape="false" />
								</td>
							</tr>
							<tr id="box">
								<td>
								...
								<td>
									<s:property value="book_infomation" escape="false" />
								</td>
							</tr>
							<tr>
